<?php
/**
 * Post a project submit free content
 *
	...
	<fieldset>
		...
		<div class="large-12 columns">
			<?php if ( 'publish' == get_post_status( $project->ID ) ) : ?>
				...
				<p><?php echo sprintf( __( 'Your project was %s successfully and is now live.', APP_TD ), $relisted ? __( 'relisted', APP_TD ) : __( 'submitted', APP_TD ) ); ?></p>
